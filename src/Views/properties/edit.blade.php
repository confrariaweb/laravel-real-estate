        ...
        <div class="row">
            ...
            <div class="col-6 text-right">
                <div class="btn-group btn-sm" role="group" aria-label="Basic">
                    <a href="{{ route('dashboard.real-estate.properties.create') }}" class="btn btn-sm btn-success">Novo</a>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    {!! Form::model($property, ['route' => ['dashboard.real-estate.properties.update', $property->id], 'method' => 'put', 'id' => 'property-form', 'class' => 'property-form', 'files' => true]) !!}
