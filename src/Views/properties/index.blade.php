	...
	<div class="container-fluid">
		<div class="form-head page-titles d-flex  align-items-center">
			<div class="mr-auto  d-lg-block">
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item active"><a href="javascript:void(0)">Propriedades</a></li>
					<li class="breadcrumb-item"><a href="javascript:void(0)">Lista</a></li>
				</ol>
			</div>
			<a href="{{ route('dashboard.properties.create') }}" class="btn btn-primary rounded light mr-3">Cadastrar</a>
		</div>
		<div class="row">
					...
					<div class="card-body">
						<div class="media align-items-center">
							<div class="media-body">
								<h2 class="fs-36 text-black font-w600">{{ $properties->count() }}</h2>
								<span class="fs-18 text-black">Total de imóveis</span>
							</div>
            ...
            <div class="col-12">
                @include('real-estate::properties.partials.list')
            </div>
        </div>
	</div>
</div>
